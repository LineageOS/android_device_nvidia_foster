...
BOARD_SUPER_PARTITION_APP_DEVICE_SIZE    := 2147483648
BOARD_SUPER_PARTITION_VENDOR_DEVICE_SIZE := 566231040
BOARD_SUPER_PARTITION_BLOCK_DEVICES      := APP vendor
BOARD_SUPER_PARTITION_METADATA_DEVICE    := APP
BOARD_SUPER_PARTITION_SIZE               := 2713714688

BOARD_NVIDIA_DYNAMIC_PARTITIONS_PARTITION_LIST := product system system_ext vendor odm
BOARD_NVIDIA_DYNAMIC_PARTITIONS_SIZE           := 2709520384
