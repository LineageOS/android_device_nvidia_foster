...
FOSTER_E_BL_VERSION = '32.00.2019.50-t210-d30cbd07'
...
def AddBootloaderFlash(info, input_zip):
  ...
  info.script.AppendExtra('            (')
  info.script.AppendExtra('              ui_print("Cannot update bootloader for fused " + getprop(ro.hardware) + ".");')
  info.script.AppendExtra('              ui_print("This is not supported. Please report to LineageOS Maintainer.");')
  info.script.AppendExtra('              abort();')
  info.script.AppendExtra('            ),')
  info.script.AppendExtra('            (')
  ...
  info.script.AppendExtra('          ),')
  info.script.AppendExtra('          (')
  info.script.AppendExtra('            ui_print("Cannot update bootloader for unfused " + getprop(ro.hardware) + ".");')
  info.script.AppendExtra('            ui_print("This is not supported. Please report to LineageOS Maintainer.");')
  info.script.AppendExtra('            abort();')
  info.script.AppendExtra('          )')
  info.script.AppendExtra('        );')
