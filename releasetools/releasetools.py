...
FOSTER_E_BL_VERSION = '32.00.2019.50-t210-ffbbebe4'
...
DARCY_BL_VERSION    = '32.00.2019.50-t210-da5c2b1b'
...
''')
  ...
  info.script.AppendExtra(f'''
    ifelse(
      ...
      (
        package_extract_file("install/" + tegra_get_dtbname(), "{DTB_PART}");
        ui_print("This is an unfused baracus. Many devlopers would kill for this unit.");
        ui_print("This is not supported. Please report to LineageOS Maintainer.");
      )
    );
''')
