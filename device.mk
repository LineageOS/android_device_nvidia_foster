...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/thermal/thermalhal.loki_e.xml:$(TARGET_COPY_OUT_VENDOR)/etc/thermalhal.loki_e_lte.xml \
    $(LOCAL_PATH)/thermal/thermalhal.loki_e.xml:$(TARGET_COPY_OUT_VENDOR)/etc/thermalhal.loki_e_wifi.xml
