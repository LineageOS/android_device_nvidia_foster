...
$(call inherit-product, device/nvidia/foster/device_tablet.mk)
else
...
# Thermal
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/thermal/thermalhal.jetson_e.xml:$(TARGET_COPY_OUT_VENDOR)/etc/thermalhal.jetson_cv.xml \
    $(LOCAL_PATH)/thermal/thermalhal.jetson_e.xml:$(TARGET_COPY_OUT_VENDOR)/etc/thermalhal.loki_e_lte.xml \
    $(LOCAL_PATH)/thermal/thermalhal.jetson_e.xml:$(TARGET_COPY_OUT_VENDOR)/etc/thermalhal.loki_e_wifi.xml
