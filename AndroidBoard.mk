...
$(INSTALLED_DTBIMAGE_TARGET_nx): $(INSTALLED_KERNEL_TARGET) | mkdtimg
	...
	$(HOST_OUT_EXECUTABLES)/mkdtimg create $@ \
		$(KERNEL_OUT)/arch/arm64/boot/dts/$(DTB_SUBFOLDER)tegra210-odin.dtb    --id=0x4F44494E --rev=0xa00 \
		$(KERNEL_OUT)/arch/arm64/boot/dts/$(DTB_SUBFOLDER)tegra210b01-odin.dtb --id=0x4F44494E --rev=0xb01 \
